...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty dontReturn;
    private SerializedProperty press;
    ...
    protected virtual void OnEnable()
    {
        ...
        dontReturn = serializedObject.FindProperty("dontReturn");
        press = serializedObject.FindProperty("press");
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(dontReturn, new GUIContent("Dont Return", "When Up joystick dont return to Zero."));
        EditorGUILayout.PropertyField(press, new GUIContent("Press", "When Button is pressed."));
    }
